...
static int import_mcdp__context(void) {
  ...
  __pyx_ptype_4mcdp_7context__CHandlerMeta = __Pyx_ImportType(module, "mcdp.context", "_CHandlerMeta", sizeof(struct DpHandlerMetaObject), __PYX_GET_STRUCT_ALIGNMENT(struct DpHandlerMetaObject),
  __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_4mcdp_7context__CHandlerMeta) goto bad;
  __pyx_ptype_4mcdp_7context_Context = __Pyx_ImportType(module, "mcdp.context", "Context", sizeof(struct DpContextObject), __PYX_GET_STRUCT_ALIGNMENT(struct DpContextObject),
  __Pyx_ImportType_CheckSize_Warn);
