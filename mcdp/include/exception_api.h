...
static int import_mcdp__exception(void) {
  ...
  __pyx_ptype_4mcdp_9exception_McdpCompileError = __Pyx_ImportType(module, "mcdp.exception", "McdpCompileError", sizeof(struct McdpCompileErrorObject), __PYX_GET_STRUCT_ALIGNMENT(struct McdpCompileErrorObject),
  __Pyx_ImportType_CheckSize_Ignore);
  ...
  __pyx_ptype_4mcdp_9exception_McdpInitalizeError = __Pyx_ImportType(module, "mcdp.exception", "McdpInitalizeError", sizeof(struct McdpInitalizeErrorObject), __PYX_GET_STRUCT_ALIGNMENT(struct McdpInitalizeErrorObject),
  __Pyx_ImportType_CheckSize_Ignore);
